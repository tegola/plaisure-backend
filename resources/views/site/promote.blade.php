...
<div class="container">
	<div class="section">
		...
		<figure class="figure">
		  <img src="{{ asset('img/promote/example.png') }}" class="figure-img img-fluid rounded" alt="Sala d'esempio con richiami alle zone modificabili">
		</figure>
		...
		<div class="row mb-5">
			<div class="col-md-10 mx-md-auto col-lg-9">
				...
				<p>{{ config('app.name') }} viene consultato dai giocatori che vogliono decidere dove passare il proprio tempo libero, e questi potrebbero scegliere proprio la tua sala!</p>
			</div>
		</div>
	</div>
