...
<div class="container mt-5 mb-1 d-flex justify-content-between align-items-center">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<p class="mb-0"><a class="btn btn-sm btn-primary" href="#">Rivendica attivit&agrave;</a>
			...
			@if ($nearby_venues->count())
				<hr>
				<h5>Attivit&agrave; nei dintorni</h5>
